...
const projects: Project[] = [
  {
    ...
    location: "Surat",
    description:
      "A carefully curated lighting design that transforms the living space into a warm, inviting environment. The combination of ambient and accent lighting creates depth and visual interest throughout the space.",
    gallery: [
      ksb1,
      ksb2,
      ksb3,
  ...
  },
  {
    ...
    location: "Surat",
    description:
      "Sophisticated residential lighting design featuring layered illumination that enhances the architectural features while maintaining optimal functionality for hospitality environments.",
  ...
  },
  {
    ...
    location: "Surat",
    description:
      "Premium Custom lighting solution that balances functional illumination with atmospheric design, creating a space that adapts to different moods and occasions.",
  ...
  },
  {
    ...
    location: "Surat",
    description:
      "An architectural lighting masterpiece that emphasizes clean lines and spatial definition. Each fixture is positioned to highlight the building's unique structural elements.",
  ...
  },
  {
    ...
    location: "Surat",
    description:
      "A bespoke lighting installation featuring custom-designed fixtures that complement the interior's unique character. Every element crafted to precise specifications.",
    gallery: [c1, c2, c3, c4],
  },
  {
    id: "project-6",
    ...
    location: "Navsari",
    description:
      "Statement lighting that doubles as art. This custom installation creates a focal point that transforms the entire spatial experience.",
  ...
  },
  {
    ...
    description:
      "Thoughtfully designed accent lighting that creates an intimate reading nook. The layered approach ensures both task lighting and ambient illumination.",
  ...
  },
  {
    ...
    description:
      "Architectural lighting that seamlessly integrates with the building's design language, enhancing spatial perception while maintaining warmth and comfort.",
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 lg:mb-16">
          ...
          <p className="text-muted-foreground">
            ...
            showcasing design excellence across residential, commercial, and
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-background/60 group-hover:bg-foreground/80 transition-colors duration-500" />
                ...
                >
                  <CarouselContent className="ml-0">
                    {selectedProject.gallery.map((media, idx) => {
                      const mediaData =
                        typeof media === "string"
                          ? { src: media, type: "image" }
                          : media;

                      return (
                        <CarouselItem key={idx} className="basis-full pl-0">
                          <div className="aspect-[16/10] lg:aspect-[21/9] overflow-hidden rounded-sm bg-background flex items-center justify-center">
                            {mediaData.type === "video" ? (
                              ...
                              <img
                                src={mediaData.src}
                                alt={`${selectedProject.title} - Item ${idx + 1}`}
                                className="w-full h-full object-contain"
                              />
                            )}
                          </div>
                ...
                {selectedProject.gallery.length > 1 && (
                  <>
                    <button
                      ...
                      className="absolute left-4 top-1/2 z-10 -translate-y-1/2 w-12 h-12 rounded-full bg-background/80 backdrop-blur-sm border border-border flex items-center justify-center hover:border-foreground transition-colors"
                    >
                      <ArrowLeft className="w-5 h-5" />
                    </button>
                    <button
                      onClick={() => carouselApi?.scrollNext()}
                      className="absolute right-4 top-1/2 z-10 -translate-y-1/2 w-12 h-12 rounded-full bg-background/80 backdrop-blur-sm border border-border flex items-center justify-center hover:border-foreground transition-colors"
                    >
