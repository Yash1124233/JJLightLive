  ...
  return (
    <section id="brochure" className="py-24 lg:py-32 bg-background">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="relative overflow-hidden rounded-sm bg-[#151413] text-primary-foreground p-10 lg:p-16">
          {/* Background Glow */}
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-primary-foreground/70 leading-relaxed mb-8 max-w-md">
                Explore our complete collection of decorative and architectural
                lighting solutions. From concept to specifications, everything
                you need in one comprehensive guide.
              </p>
              <Button
                variant="heroOutline"
            ...
            <div className="relative">
              <div
                className="relative w-full max-w-sm mx-auto lg:mx-0 lg:ml-auto aspect-[3/4] rounded-sm shadow-2xl overflow-hidden group cursor-pointer"
                onClick={handleDownload}
              >
                <img
                  src="/brochures/brochure_thumbnail.png"
