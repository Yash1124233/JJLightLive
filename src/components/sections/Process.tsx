...
const steps = [
  {
    ...
    description:
      "We begin by immersing ourselves in your vision, studying the architecture, and understanding how light will interact with every surface.",
  },
  {
    number: "02",
    icon: PenTool,
    ...
    description:
      "Our designers create detailed concepts, exploring materials, forms, and lighting effects that align perfectly with your aesthetic.",
  },
  {
    number: "03",
    icon: Cog,
    ...
    description:
      "Every piece is handcrafted in our atelier using premium materials, with rigorous quality control at every stage.",
  },
  {
    number: "04",
    icon: CheckCircle,
    ...
    description:
      "Our expert team ensures flawless installation, fine-tuning every detail to achieve the perfect illumination.",
  },
];
